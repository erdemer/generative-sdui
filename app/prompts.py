...
✓ HEADER: Row(spacebetween,center,padding:"12,16,12,16") > [Row(spacedby:8) > [Image(w:28, h:28, url:"https://image.pollinations.ai/prompt/vodafone_red_circle_logo_isolated_on_white?nologo=true&width=100&height=100&model=flux") or Icon(domain,accent), Text(h3,bold,accent,"App Name")], Row(spacedby:12) > [Icon(search,fg3), Icon(notifications,fg3)]]
